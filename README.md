...
### Микрооперации для работы с функциями [100-199]
| Микрокоманда | Код | Описание                                                              |
|--------------|-----|-----------------------------------------------------------------------|
...
### Микрооперации типов переменных и функций [200-299]
| Микрокоманда | Код | Команда                                           |
|--------------|-----|---------------------------------------------------|
...
#### like()
Функция ищет вхождения подстроки в исходную строку и возвращает позицию первого вхождения или -1 (если не было найдено)

`like(A: string, B: string) : int`
...
**Список параметров:**
- `A` - число, которое будет взято по модуль
...
#### log()
Функция возвращает значение натурального логарифма для переданного числа

`log(A: float) : float`

**Список параметров:**
- `A` - число, натуральный логарифм которого будет вычислен
