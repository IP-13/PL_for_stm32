**PL-cLab** - это Forth-подобный язык программирования для STM32.
...
- [Работа с PL-cLab](#основные-положения)
...
## Вызов функций 
Чтобы вызвать любую функцию (свою или из PL-cLab core) требуется после точки входа в основной листинг программы прописать с маленькой буквы имя нужной функции.
...
Работа языка PL-cLab осуществляется по следующим шагам:
...
# PL-cLab core
Подробнее о стандартной библиотеке языка PL-cLab. В рамках данной библиотеки были реализованы самые необходимые базовые функции для проведения вычислений. Любые не представленные здесь функции можно получить с помощью арифметических операций: например, тангенс можно получить путём деления синуса на косинус.
